  ...
  const features = [
    {
      ...
      description:
        "Select your target role, difficulty level, and number of questions. Customize your interview to match real job requirements, gives you more accurate, faster results than similar tools",
    },
    {
      icon: "②",
      title: "Start Answering the mock interview tailored to your job role",
      description:
        "Instantly creates relevant technical and behavioral questions tailored specifically to your selected role and difficulty.",
    },
    {
      icon: "③",
      title: "Get instant AI feedback",
      description:
        "See what works, make improvements compare with previous interview history ",
    },
    {
      icon: "④",
      ...
      <div className="max-w-7xl mx-auto px-8 pb-24">
        ...
        <div className="text-center mb-16 mt-10 text-5xl">
          <h1 className="font-medium mb-3">
            How to Use Interview AI Mock Interview
          </h1>
          <p className="text-lg font-light text-gray-500">
            Get ready for the interview with guided practice, real-time feedback
            and
